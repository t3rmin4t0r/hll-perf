...
public class HllBenchmark {
  ...
  public static class BenchmarkState {
    ...
    final NumDistinctValueEstimator nv0 = hll.deserialize(itemHLL);
    final NumDistinctValueEstimator nv1 = hll.deserialize(itemHLL);
    final NumDistinctValueEstimator nv2 = hll.deserialize(warehouseHLL);
  }
  ...
  public NumDistinctValueEstimator benchDeserialize(BenchmarkState state) {
    return state.hll.deserialize(state.itemHLL);
  }
